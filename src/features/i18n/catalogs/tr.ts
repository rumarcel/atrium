...
const turkishOverrides = {
  ...
  "verdict.allWell": "Her şey çalışıyor",
  "verdict.uptime": "{{uptime}} çalışıyor",
  "verdict.connecting": "Sunucuya bağlanılıyor",
  "verdict.unreachable": "Sunucuya ulaşılamıyor",
  "verdict.noMonitoring": "Sunucu izleme yapılandırılmadı",
  "verdict.stale": "Veriler güncel değil",
  "verdict.servicesDown": "{{count}} servis yanıt vermiyor",
  "verdict.servicesAttention": "{{count}} servise bakmak gerek",
  "verdict.diskPressure": "Disk %{{percent}} dolu",
  "verdict.memoryPressure": "Bellek %{{percent}}",
  "verdict.cpuPressure": "İşlemci yükte",
  "dashboard.noServices": "Henüz etkin servis yok.",
  "shell.details": "Sunucu ayrıntıları",
  "shell.activity": "Etkinlik",
  "nav.label": "Bölümler",
  "nav.tagline": "Ev sunucun, her yerde.",
  "nav.home": "Ana Menü",
  ...
  "nav.onlineCount": "{{total}} servisten {{online}} tanesi çevrimiçi",
  "home.greeting": "Hoş geldin!",
  "home.question": "Bugün ne açıyoruz?",
  "home.subtitle": "Ev sunucun ve kullandığın servisler tek yerde.",
  "home.serverStatus": "Sunucu durumu",
  "home.uptimeLabel": "Çalışma süresi: {{uptime}}",
  "home.storageUsed": "{{total}} kapasitenin {{used}} kadarı kullanılıyor",
  "home.networkLabel": "Ağ",
  "home.networkRates": "İndirme {{download}} · Yükleme {{upload}}",
  "home.myServices": "Servislerim",
  "home.seeAll": "Tüm servisleri gör",
  "home.quickActions": "Hızlı işlemler",
  "home.openMedia": "Medya Aç",
  "home.openMediaNote": "{{serviceName}} başlat",
  "home.openDownloads": "İndirmeler",
  "home.openDownloadsNote": "{{serviceName}} aç",
  "home.refreshAll": "Sunucuyu Yenile",
  "home.refreshAllNote": "Servisleri kontrol et",
  "home.noQuickAction": "Yapılandırılmadı",
  "nav.storage": "Depolama",
  "storage.subtitle": "Sunucunun bildirdiği tüm dosya sistemleri ve doluluk oranları.",
  "storage.unavailable": "Depolama verisi için izleme sağlayıcısı gerekiyor.",
  "storage.totalLabel": "Toplam kapasite",
  "storage.totalNote": "Tüm cihazlarda",
  "storage.usedLabel": "Kullanılan",
  "storage.freeLabel": "Boş",
  "storage.share": "kapasitenin {{percent}} kadarı",
  "storage.devicesLabel": "Cihaz",
  "storage.mountCount": "{{count}} bağlı yol",
  "storage.devicesHeading": "Cihazlar",
  "storage.mountsHeading": "Bağlı dosya sistemleri",
  "storage.nearlyFull": "Neredeyse dolu",
  "storage.colDevice": "Cihaz",
  "storage.colFileSystem": "Dosya sistemi",
  "storage.colMount": "Bağlı yol",
  "storage.colSize": "Boyut",
  "storage.colUsed": "Kullanım",
  ...
  "monitoring.showVolumes": "Tüm birimleri göster",
  "monitoring.hideVolumes": "Birimleri gizle",
  "monitoring.volumes": "Birimler",
  ...
  "service.online": "Çevrimiçi",
  "service.localTls": "Yerel TLS",
