fn main() {
    const COMMANDS: &[&str] = &[
        ...
        "get_desktop_integration_settings",
        "save_desktop_integration_settings",
        "set_desktop_startup_enabled",
        "get_server_control_snapshot",
        "save_server_control_settings",
        "refresh_server_control_status",
        "prepare_server_control_action",
        "confirm_server_control_action",
        "cancel_server_control_operation",
        "dismiss_server_control_confirmation",
